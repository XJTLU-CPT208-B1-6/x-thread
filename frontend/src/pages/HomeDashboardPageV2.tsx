...
export default function HomeDashboardPageV2() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.18),_transparent_28%),linear-gradient(135deg,_#0f172a_0%,_#134e4a_42%,_#f8fafc_100%)] px-4 py-8 text-slate-900">
          ...
          <div className="grid gap-0 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="border-b border-slate-200/70 bg-[linear-gradient(135deg,_rgba(15,118,110,0.12),_rgba(14,165,233,0.06),_rgba(255,255,255,0.96))] p-8 lg:border-b-0 lg:border-r">
              <div className="text-xs font-semibold uppercase tracking-[0.28em] text-teal-700">
                X-Thread Account Workspace
              </div>
              <h1 className="mt-4 max-w-2xl text-4xl font-black tracking-tight text-slate-900">
                账号绑定房间、AI 配置与个人历史记录
              </h1>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-600">
                注册时使用邮箱与验证码完成绑定。登录后，你的 AI 设置、已加入房间历史、当前活跃房间都会跟随账号同步。
              </p>

              <div className="mt-8 grid gap-4 sm:grid-cols-3">
                <div className="rounded-3xl border border-teal-100 bg-white px-5 py-4 shadow-sm">
                  <div className="text-xs uppercase tracking-[0.22em] text-teal-600">注册方式</div>
                  <div className="mt-2 text-lg font-semibold text-slate-900">邮箱验证码</div>
                  <div className="mt-2 text-sm text-slate-500">注册时强制邮箱校验，登录采用账号密码。</div>
                </div>
                <div className="rounded-3xl border border-sky-100 bg-white px-5 py-4 shadow-sm">
                  <div className="text-xs uppercase tracking-[0.22em] text-sky-600">AI 设置</div>
                  <div className="mt-2 text-lg font-semibold text-slate-900">账号级恢复</div>
                  <div className="mt-2 text-sm text-slate-500">切换设备或刷新页面后仍可恢复 AI 提供商和模型配置。</div>
                </div>
                <div className="rounded-3xl border border-amber-100 bg-white px-5 py-4 shadow-sm">
                  <div className="text-xs uppercase tracking-[0.22em] text-amber-600">历史保留</div>
                  <div className="mt-2 text-lg font-semibold text-slate-900">14 天房间记录</div>
                  <div className="mt-2 text-sm text-slate-500">离开或房间解散后，历史查询保留 14 天，文件下载保留 7 天。</div>
                </div>
              </div>
            </div>
          ...
          <section className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-[28px] border border-white/25 bg-white/90 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.12)] backdrop-blur">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h2 className="mt-2 text-2xl font-black text-slate-900">正在参与的房间</h2>
                </div>
                <button
                  type="button"
            ...
            <div className="rounded-[28px] border border-white/25 bg-white/90 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.12)] backdrop-blur">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-black text-slate-900">14 天内的历史房间</h2>
              </div>
